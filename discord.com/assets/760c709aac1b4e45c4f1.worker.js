  ...
  var r = {
      390: (r) => {
        ...
        r.exports = function (r, o) {
          ...
          if (l > e) return !1;
          if (l === e) return r === o;
          r: for (var n = 0, t = 0; n < l; n++) {
            for (var i = r.charCodeAt(n); t < e; )
              if (o.charCodeAt(t++) === i) continue r;
            return !1;
          }
          return !0;
        };
      ...
      957: (r, o, e) => {
        var l = "object" == typeof e.g && e.g && e.g.Object === Object && e.g;
        r.exports = l;
      },
      607: (r, o, e) => {
        var l = e(705),
      ...
      279: (r, o, e) => {
        ...
        r.exports = function (r, o, e) {
          ...
          if (l(e)) {
            d = !!e.leading;
            f = (y = "maxWait" in e) ? i(t(e.maxWait) || 0, o) : f;
          ...
          function w(r) {
            var e = r - v;
            return void 0 === v || e >= o || e < 0 || (y && r - p >= f);
          }
          function E() {
            var r = n();
            if (w(r)) return T(r);
      ...
      448: (r, o, e) => {
        var l = e(239),
          n = e(5);
        r.exports = function (r) {
          return "symbol" == typeof r || (n(r) && "[object Symbol]" == l(r));
        };
      },
      771: (r, o, e) => {
        var l = e(639);
      ...
      681: (r, o, e) => {
        ...
        function c(r, o) {
          ...
          for (var e = 0, l = new Array(o); e < o; e++) l[e] = r[e];
          return l;
        }
        function f(r) {
          return (
            ...
            (function (r, o) {
              if (!r) return;
              if ("string" == typeof r) return c(r, o);
        ...
        var O =
            null == String.prototype.normalize
              ...
              : function (r) {
                  return r.normalize("NFD").replace(s, "").normalize("NFC");
                },
          v = a;
        var p =
          null == String.prototype.normalize
            ...
            : function (r) {
                var o = "";
                f(r.normalize("NFD")).forEach(function (r) {
                  var e;
                  o += null !== (e = v[r]) && void 0 !== e ? e : r;
                });
          ...
          if (r.score === o.score) {
            var e,
              ...
              a =
                null !==
                  (t =
                    null !== (n = r.sortable) && void 0 !== n
                      ? n
                      : null === (e = r.comparator) || void 0 === e
                      ? void 0
                      : e.toLocaleLowerCase()) && void 0 !== t
                  ? t
                  : "",
              c =
                null !==
                  (u =
                    null !== (i = r.sortable) && void 0 !== i
                      ? i
                      : null === (l = o.comparator) || void 0 === l
                      ? void 0
        ...
        function A(r) {
          ...
          o.forEach(function (r) {
            var o,
              n = r.id,
              t = b(r, ["id"]),
              i = null !== (o = T.get(n)) && void 0 !== o ? o : null,
              u = (function (r) {
          ...
          j.forEach(function (r, o) {
            var n = r.filters;
            (null == n || n.friends === e || l.has(n.guild)) && x.add(o);
          });
          C();
        }
        var C = i()(
        ...
        function N(r, o) {
          var e,
            ...
            f = o.whitelist,
            s =
              null != a && a.strict && null !== (e = a.guild) && void 0 !== e
                ? e
                : null,
            v = null !== (l = o.boosters) && void 0 !== l ? l : {},
            y = new RegExp("^".concat(u(t)), "i"),
            b = new RegExp(u(t), "i"),
            g = [];
          if ("" === t) return X(t, g, r);
          var h = t.toLocaleLowerCase(),
            w = p(h);
          T.forEach(function (r, o) {
            if (
              (function (r, o, e, l, n) {
                if (null != l && l.indexOf(r) >= 0) return !1;
                if (null != n && n.indexOf(r) >= 0) return !0;
                if (null != e) {
                  var t = e.friends,
                    i = e.guild;
                  return (
                    (!0 === t && !0 === o.isFriend) ||
                    (null != i && (null != o[i] || null === o[i]))
                  );
                }
                return !0;
              })(o, r, a, c, f)
              ...
              o === t
                ...
                : Object.keys(r).forEach(function (t) {
                    ...
                    if (
                      ...
                      var u,
                        a = O(i.toLocaleLowerCase());
                      y.test(i)
                        ? (u = { comparator: i, score: L(10, v[o]) })
                        : b.test(i)
                        ? (u = { comparator: i, score: L(5, v[o]) })
                        : (n()(h, a) || n()(w, p(a))) &&
                          (u = { comparator: i, score: L(1, v[o]) });
                      if (null != u) {
                        (null == e || e.score < u.score) && (e = u);
                        e.id = o;
                        e.username = l;
                      }
                    }
          ...
          g.sort(d);
          g.length > i && (g.length = i);
          X(t, g, r);
        }
        function X(r, o, e) {
          var l = { type: h, uuid: e, payload: { query: r, results: o } };
          self.postMessage(l);
        }
...
//# sourceMappingURL=760c709aac1b4e45c4f1.worker.js.map
